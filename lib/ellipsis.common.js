...
function makeEllipsis(el, content, position, fill) {
  content = clearContent(content); // 设置样式
  ...
  switch (position) {
    ...
    default:
      throw new Error("Ellipse: Invalid position value \"".concat(position, "\", available: start, middle, end"));
  }
...
function render(el, _ref, vnode) {
  ...
  var _ellipsis$make = ellipsis.make(el, text, position, fill),
