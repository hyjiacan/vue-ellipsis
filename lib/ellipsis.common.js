...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"2eec11e7-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Template.vue?vue&type=template&id=11da83ea&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"title":_vm.tipText}},[_vm._t("default")],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/Template.vue?vue&type=template&id=11da83ea&
...
/* harmony default export */ var component = ({
  ...
  methods: {
    update: function update() {
      ...
      this.$nextTick(function () {
        _this.$el.innerHTML = _this.makeEllipsis();
      });
    },
    createProxy: function createProxy(parent) {
    ...
    makeEllipsis: function makeEllipsis() {
      // 设置样式
      var contentStyle = this.getContainerStyle();
      ...
      var contentWidth = parseFloat(this.getContentProxyStyle().width);
      var fillWidth = parseFloat(this.getFillProxyStyle().width);
      var contentLength = this.content.length;
      var containerWidth = parseFloat(contentStyle.width);
      ...
      switch (this.position) {
        ...
        default:
          throw new Error("Ellipse: Invalid position value \"".concat(this.position, "\""));
      }
    },
    makeLeftEllipsis: function makeLeftEllipsis(containerWidth, contentLength, fillWidth) {
      ...
      return "".concat(this.fill).concat(suffix);
    },
    makeCenterEllipsis: function makeCenterEllipsis(containerWidth, contentLength, fillWidth) {
      var size = containerWidth - fillWidth;
      var prefix = '';
      var suffix = '';
      ...
      return "".concat(prefix).concat(this.fill).concat(suffix);
    },
    makeRightEllipsis: function makeRightEllipsis(containerWidth, contentLength, fillWidth) {
      var size = containerWidth - fillWidth;
      var prefix = '';
      ...
      return "".concat(prefix).concat(this.fill);
    },
    getWordWidth: function getWordWidth(word) {
      // 使用 &nbsp; 作为空格来计算字符长度
      this.wordProxy.innerHTML = word === ' ' ? '&nbsp;' : word;
      return parseFloat(window.getComputedStyle(this.wordProxy).width);
    },
    getContentProxyStyle: function getContentProxyStyle() {
      return window.getComputedStyle(this.contentProxy);
    },
    getFillProxyStyle: function getFillProxyStyle() {
  ...
  computed: {
    slotContent: function slotContent() {
      if (!this.$slots.default) {
        return '';
      }

      var elm = this.$slots.default[0].elm;
