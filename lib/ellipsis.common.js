...
function autoSize(content, contentProxy, contentWidth, containerWidth, containerStyle) {
  ...
  return [Math.round(fontsize) > Math.round(scale), "<svg viewBox=\"0 -".concat(height / 2, "0 ").concat(containerWidth, " ").concat(height, "\"><text x=\"0\" y=\"0\" style=\"font-size: ").concat(scale, "px;\">").concat(content, "</text></svg>")];
}
/**
 *
 * @param el
